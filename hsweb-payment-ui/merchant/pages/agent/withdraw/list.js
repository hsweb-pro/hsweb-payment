define([], function () {
    ...
    function init(containerId) {
        require(["text!pages/agent/withdraw/list.html"], function (html) {
    ...
    function initTable() {
        layui.use(['table', 'form', 'laydate'], function () {
                ...
                table.render({
                    elem: '#substitute'
                    , url: '/current-agent/withdraw-log'
                    , title: '提现列表'
                    , totalRow: true
                    , cols: [[
                        ...
                        // , {fixed: 'right', title: '操作', width: 100, toolbar: '#withdraw-action'}
                    ]]
                    ,
                    id: 'substituteReload'
                    , request: {
                ...
                $(".yesterday-order").on("click", function () {
                    ...
                    var str1 = formatDate(day, "yyyy-MM-dd");
                ...
                $(".seven-days-order").on("click", function () {
                    ...
                    var sevenDay = formatDate(day, "yyyy-MM-dd");
                ...
                $(".month-order").on("click", function () {
                    ...
                    var thirtyDay = formatDate(day, "yyyy-MM-dd");
        ...
        $(".apply-btn").on('click', function () {
            var menu = {
                id: "apply",
                name: "提现申请",
                url: "./pages/agent/withdraw/apply/list"
            };
            loadMenu(menu);
        });
    }
