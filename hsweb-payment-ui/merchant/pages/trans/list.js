define(["request"], function (request) {
    ...
    function init(containerId) {
        require(["text!pages/trans/list.html"], function (html) {
    ...
    function initTable() {
        layui.use(['table', 'form', 'laydate', 'layer'], function () {
            ...
            table.render({
                elem: '#trans'
                , url: '/account-trans-log/merchant/trans-log'
                , totalRow: true
                , cols: [[
                        ...
                        , where: encodeParams(
                            {
                                ...
                                transType$in: transType.val()==="CHARGE"?"CHARGE,AGENT_CHARGE":transType.val(),
