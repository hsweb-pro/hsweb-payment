...
/**
 * @Filename Money.java @Description 单币种货币类，处理货币算术、币种和取整。
 *
...
public class Money implements Serializable, Comparable<Object> {
    ...
    public Money(String amount) {
        this(
                amount == null || "".equals(amount) ? "0" : amount.replace(",", ""),
    ...
    public Money(String amount, Currency currency, int roundingMode) {
        this(
                new BigDecimal(amount == null || "".equals(amount) ? "0" : amount), currency, roundingMode);
    }
